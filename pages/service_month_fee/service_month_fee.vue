	...
	<div>
		...
		<div class="service_wrap">
			...
			<div class="service_look">
				<span>点击查看</span>
				<navigator :url="'/pages/agreement/agreement?monthly_expense='+monthly_expense+'&mileage_expense='+mileage_expense">
		...
		<div class="modal-dialog" v-if="showWaitModal">
			...
			<div class="modal-title" style="padding: 20upx 20upx 0 20upx; margin-bottom: 60upx;">核保中，稍后有客服人员与您联系，请耐心等候</div>
			<div class="modal-footer">
	...
	export default {
		...
		methods: {
			...
			async applyUnderwrite() {
				...
				// }
				let params ={
					insurer:this.item.details.data[0].insurerCode,
					biz_id:this.item.details.data[0].bizID,
					channel_code:"QUANLIAN_PROXY_INSURE",
					address_name:this.global.name,
					address_mobile:this.global.mobile,
