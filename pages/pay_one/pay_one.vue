...
<div class="container container-fill">
  ...
  <div class="item">
    <div class="item_left">
      <img src="../../static/img/finish_gray.png" alt="">
      <span></span>
      <img src="../../static/img/finish_ready.png" alt="">
    </div>

    <div class="right">
        <div class="item_right">
          <div class="item_right_wrap">
            <span class="name">里程车险</span>
            <span class="money">服务费用：400元</span>
          </div>
          <span class="item_status">已付款</span>
        </div>
...
export default {
  ...
  methods: {
    next () {
      wx.navigateTo({
        url: "../pay_all/pay_all?jiaoqiang_order_id="+this.jiaoqiang_order_id + '&quotation_id='+this.quotation_id
      })
    },
  },
