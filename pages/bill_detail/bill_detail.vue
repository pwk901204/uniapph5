<template>
	<div class="container">
		...
		<div class="list_wrap">
			<div class="ticket" v-for="(item,index) in list" :key="index" @click="next(item)" v-if="((item.type == 1) || (item.type == 2))">
				<div class="main">
						...
						if (!openid) {
							if (isWeiXin()) {
								...
								window.location.href =
									...
									"%2flccx2%2findex.html%23%2fpages%2fpay_address%2fpay_address%3fquotation_id%3d" + item.quotation_id +
